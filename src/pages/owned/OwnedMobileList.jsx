...
function MobileRow({ card, state, isSelected, onToggleRow, onMarkNotOwned }) {
  return (
    <div className={`p-3 ${isSelected ? 'bg-glaceon/10' : ''}`}>
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center w-10 h-10 rounded-lg bg-rose-100 dark:bg-rose-900/40 text-rose-700 dark:text-rose-200 hover:bg-rose-200 dark:hover:bg-rose-900/60 transition shadow-sm"
          title="Mark not owned"
...
export default function OwnedMobileList({ cards, collection, selected, onToggleRow, onMarkNotOwned }) {
  return (
